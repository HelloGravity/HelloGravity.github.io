...
/*taken directly from the source, added scaling*/
Phaser.Physics.P2.Body.prototype.loadPolygon = function (key, object, scaleX, scaleY) {
    if(scaleX == undefined || scaleX <= 0) scaleX = 1;//altered
    if(scaleY == undefined || scaleY <= 0) scaleY = scaleX;//altered
    ...
    for (var i = 0; i < data.length; i++)
    {
        ...
        {
            vertices.push([ this.world.pxmi(data[i].shape[s]*scaleX), this.world.pxmi(data[i].shape[s + 1]*scaleY) ]);//altered
        }
