function alienCity(game) {
	...
	var step = 0;
	this.init = function() {
		game.text1 = text1 = game.add.sprite(789,158, 'aliencity-alientext1');
		game.text2 = text2 = game.add.sprite(791,120, 'aliencity-alientext2');
		game.text3 = text3 = game.add.sprite(782,118, 'aliencity-alientext3');
		...
		game.player = player = game.add.sprite(308,417, 'landedmars-astrowalk');
